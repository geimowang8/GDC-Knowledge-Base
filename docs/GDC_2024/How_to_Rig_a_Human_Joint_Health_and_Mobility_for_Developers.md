---
title: "How to Rig a Human: Joint Health and Mobility for Developers"
video_id: SejWMkVEKlE
url: https://www.youtube.com/watch?v=SejWMkVEKlE
views: 4530
year: 2024
...
[在 YouTube 上观看](https://www.youtube.com/watch?v=SejWMkVEKlE)
...
Now, whichever shoulder is pointed at those guys— No, no, no, stay in that position. Hold that position.
...
It used to be, we used to think, well, if we could just figure out to—I mean, that's why massage used to be so popular.
We used to just think, like, oh, if we could just relax everything, you'll be fine.
Problem is we know that's not true.
The problem is we know we need some of that tension, and not having that tension—for example, if you've ever seen people who are really, really flexible, they end up having joint problems because that tension isn't there.
